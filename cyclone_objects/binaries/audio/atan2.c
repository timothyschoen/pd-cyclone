...
CYCLONE_OBJ_API void cyclone_atan2_tilde_setup(void)
{
    atan2_class = class_new(gensym("cyclone/atan2~"), (t_newmethod)atan2_new, (t_method)atan2_free, sizeof(t_atan2), CLASS_MULTICHANNEL, A_DEFFLOAT, 0);
